...
blocks:
  - title: "BoardGameGeek"
    row:
      ...
      - "GeekMarket | https://boardgamegeek.com/geekmarket/browse"
  - label: Complexity
    from: bgg:complexity
  - label: Duration
    from: bgg:duration
  - label: Light 20 Minutes
    from: bgg:light20
  - label: Players
    from: bgg:players
  - label: All Games
  ...
  - title: "Reviews"
    row:
      ...
      - "Countdowns | https://www.youtube.com/@thedicetower/search?query=top"
      - "Week in Review | https://www.youtube.com/playlist?list=PLOlRvTbmD6tLXrBugjAV1nlFMW5Z4OzJy"
      - "Latest Reviews | https://dicetower.com/dice-tower-reviews"
  - row:
